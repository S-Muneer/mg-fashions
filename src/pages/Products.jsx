...
import StickySortBar from "../components/StickySortBar";
      ...
      <section className="py-10 sm:py-14 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <ScrollReveal delay={80}>
            <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-4 sm:mb-8 grid gap-3 grid-cols-1">
              <input
                value={query}
          ...
          <StickySortBar sortBy={sortBy} onSortChange={setSortBy} />

          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 pt-8">
            {error ? (
            ...
            {loading ? (
              ...
              <p className="text-sm text-slate-600 col-span-full">
                No items match your search. Try a broader category or keyword.
              </p>
            )}
          </div>
        </div>
